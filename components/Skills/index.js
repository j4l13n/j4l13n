    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col d-flex justify-content-center">
          <h3 className="">Tools / Skills / Programming Languages</h3>
        </div>
      </div>
      <div className="row py-5">
        <div className="col-md-2 shadow-sm d-flex justify-content-center">
          {/* <a href="#" className="p-2 z-depth-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Tooltip on top"> */}
            <img src="/python-4.svg" alt="Python" className="w-100 h-100 z-depth-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Python" />
          {/* </a> */}
        </div>
        <div className="col-md-2 shadow-sm d-flex justify-content-center">
          <img src="/django-community.svg" className="p-2 w-100 h-100 z-depth-2" alt="Django" />
        </div>
        <div className="col-md-2 shadow-sm d-flex justify-content-center">
